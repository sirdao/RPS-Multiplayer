var myDataRef = new Firebase('https://rps-ucf0329.firebaseio.com/');
var chatData = new Firebase('https://rps-ucf0329.firebaseio.com/chat');
var playersRef = new Firebase('https://rps-ucf0329.firebaseio.com/players');
var currentTurnRef = new Firebase('https://rps-ucf0329.firebaseio.com/turn');
...
function getInGame() {
  ...
  var chatDataDisc = new Firebase('https://rps-ucf0329.firebaseio.com/chat/' + Date.now());
  ...
  if (currentPlayers < 2) {
    ...
    playerRef = new Firebase('https://rps-ucf0329.firebaseio.com/players/' + playerNum);
